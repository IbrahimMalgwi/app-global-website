...
const BlogPreview = ({ icon: Icon, title, description, delay = 0 }) => (
    ...
    >
        <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-red-600 rounded-xl opacity-0 group-hover:opacity-10 dark:group-hover:opacity-20 blur transition-opacity duration-300" />
...
export default function Newsletter() {
    ...
    return (
        <section id="newsletter" className="relative py-24 overflow-hidden bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black">
            {/* Animated Background */}
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                            ...
                            <div className="p-8 md:p-10">
                                ...
                                <div className="text-center mb-8">
                                    <motion.div
                                        ...
                                        className="w-16 h-16 bg-gradient-to-br from-red-100 to-red-100 dark:from-red-900/30 dark:to-red-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4"
                                    >
                                        ...
                                        {isSubscribed ? (
                                            ...
                                            >
                                                <div className="relative group/input">
                                                    <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-red-600 rounded-xl opacity-0 group-focus-within/input:opacity-20 blur transition-opacity duration-300" />
                                                    <input
                                                        ref={inputRef}
                                                        type="email"
                                                        value={email}
                                                        ...
                                                        className={`w-full px-6 py-4 bg-white dark:bg-gray-700 border-2 rounded-xl outline-none transition-all duration-300 text-gray-900 dark:text-white ${
                                                            emailError
                                                                ...
                                                                : 'border-gray-200 dark:border-gray-600 focus:border-red-500 dark:focus:border-red-400'
                                                        }`}
                                                    />
                                                    {emailError && (
                                                ...
                                                <motion.button
                                                    ...
                                                    whileTap={{ scale: 0.98 }}
                                                >
                                                    <div className="absolute inset-0 bg-red-600 dark:bg-gradient-to-r dark:from-red-600 dark:to-red-600" />
                                                    <div className="relative z-10 inline-flex items-center justify-center gap-2 w-full px-6 py-4 bg-red-600 dark:bg-gradient-to-r dark:from-red-600 dark:to-red-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-red-500/50 transition-all duration-300">
                                                        Subscribe Now
                ...
                >
                    <a
                        href="#blog"
                        className="inline-flex items-center gap-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors group"
                    >
